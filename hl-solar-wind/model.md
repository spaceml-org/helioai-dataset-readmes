...
The processed dataset is a **time-aligned, multi-modal dataset**, where each row corresponds to a PSP measurement and its associated solar origin.

## What a row represents

Each row corresponds to:

> A **solar wind measurement at PSP**, combined with:
- its **plasma and magnetic properties**
- its **solar source region (via WSA backmapping)**
- the corresponding **SDO observation (via alignment index)**
- a **solar wind regime label**
