...
|---|---|
| Challenge | Heliolab 2025 ARCADE |
| Model Type | Physics-informed hybrid neural–physical forecasting system |
| Primary Objective | Forecast short-term evolution of the solar surface magnetic field |
| Forecast Target | Active region magnetic evolution and flux emergence |
| Forecast Horizon | ~6–12 hours (interactive demo up to ~30 hours) |
| Primary Physical Framework | Surface Flux Transport (SFT) equation |
| Neural Components | ResNet-style CNN encoder, learned flow/source networks, uncertainty head |
| Numerical Framework | Differentiable Neural ODE (`torchdiffeq`) with RK4 integration |
| Inputs | Multi-modal SDO observations (HMI + AIA) |
| Outputs | Forecast magnetograms, uncertainty maps, residual diagnostics, learned physical parameters |
| Physics Constraints | Differential rotation, meridional flow, turbulent diffusion |
| Learnable Physical Quantities | Flux emergence source term, flow parameters |
| Uncertainty Quantification | Optional pixel-wise probabilistic forecasting |
| Operational Goal | Interpretable, uncertainty-aware solar magnetic field forecasting |
...
#### b. Differentiable SFT evolution module (PDE)
...
#### c. Learned flux emergence (source term)
...
#### d. Uncertainty quantification head (optional)
